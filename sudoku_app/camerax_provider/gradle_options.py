...
def before_apk_build(toolchain):
    ...
    # required_depends = [f'androidx.camera:camera-core:{camerax_version}',
    #                     f'androidx.camera:camera-camera2:{camerax_version}',
    #                     f'androidx.camera:camera-lifecycle:{camerax_version}',
    #                     f'androidx.camera:camera-video:{camerax_version}',
    #                     f'androidx.camera:camera-view:{camerax_version}',
    #                     # f'androidx.camera:camera-mlkit-vision:{camerax_version}',
    #                     f'androidx.camera:camera-extensions:{camerax_version}'
    #                     ]
